      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        {educationData.map((edu) => (
          <div key={edu.institution} className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-white font-bold text-[12px] uppercase tracking-wider mb-2">{edu.institution}</h3>
            <p className="text-slate-200 text-[11px] font-medium mb-1">{edu.degree}</p>
            <p className="text-slate-500 text-[10px] leading-relaxed mb-4 max-w-[200px]">{edu.focus}</p>
